# -*- coding: utf-8 -*-
#
# peerannot documentation build configuration file, created by
...
latex_documents = [
    (
        master_doc,
        "peerannot.tex",
        u"peerannot Documentation",
        u"peerannot contributors",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "peerannot", u"peerannot Documentation", [author], 1)
]
