...
project = "peerannot"
copyright = f"2023-{datetime.today().year}"
author = "peerannot contributors"
...
#     "repository_url": "https://github.com/peerannot/peerannot",
# }
...
htmlhelp_basename = "peerannotdoc"
...
latex_documents = [
    (
        master_doc,
        "peerannot.tex",
        "peerannot Documentation",
        "peerannot contributors",
        "manual",
    ),
]
...
man_pages = [(master_doc, "peerannot", "peerannot Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "peerannot",
        "Handle crowdsourcing datasets easily.",
        "Miscellaneous",
    ),
]
